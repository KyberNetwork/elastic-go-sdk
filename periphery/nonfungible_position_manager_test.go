...
func TestAddCallParameters(t *testing.T) {
	...
	params, err = AddCallParameters(pos, opts)
	assert.NoError(t, err)
	assert.Equal(t, "", hexutil.Encode(params.Calldata))
	assert.Equal(t, "0x00", utils.ToHex(params.Value))
